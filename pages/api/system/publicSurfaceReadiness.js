...
const personaSourceChecks = [
  ...
  },
  {
    ...
    requires: ['Open sample case', 'Start urgent path', 'Prepare during care', 'Plan ahead', 'One family record', 'Active plan', 'Who owns each next step', 'Prepared output', "You've been asked to handle a next step", 'Handoff ready', 'Same family record across planning, urgent help, funeral-home handoffs, and participant views.', 'own this next step', 'family-record work connected to you', 'FamilyOperatingStepCard', 'taskOperatingContractFor', 'One owner, one waiting point, one proof trail.', 'Details stay behind this action', 'Family operating sheet', 'Prepared message workspace', 'Review before send'],
