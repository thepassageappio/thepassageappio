...
import { rateLimitPolicyChecklist, refreshPolicyChecklist } from '../../../lib/rateLimitPolicy';
...
const wiredProtections = [
  ...
  { route: '/api/system/*Readiness', policy: 'adminReadiness', status: 'defined', proof: 'Policy exists; remaining readiness routes should adopt the shared limiter.' },
