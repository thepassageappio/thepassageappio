...
const wiredProtections = [
  ...
  { route: '/api/partnerInvite', policy: 'outboundDelivery', status: 'wired', proof: 'Partner owner invites are throttled by IP, admin, organization, recipient, and action before Resend delivery, with QA override routing preserved.' },
  { route: '/api/partnerStaffInvite', policy: 'outboundDelivery', status: 'wired', proof: 'Employee invites are throttled by IP, sender, organization, and recipient before Resend delivery, with QA override routing preserved.' },
  { route: '/api/funeralHomePrepEmail', policy: 'outboundDelivery', status: 'wired', proof: 'Funeral-home preparation summaries are throttled by IP, sender/source, estate, and recipient before Resend delivery, with QA override routing preserved.' },
