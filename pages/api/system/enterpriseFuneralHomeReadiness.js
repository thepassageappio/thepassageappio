...
export default async function handler(req, res) {
  ...
  const accounts = orgs.map(org => {
    ...
    const gates = [
      ...
      gate('needs_help', 'Needs-help work controlled', blockedTasks.length ? 'blocked' : 'ready', `${blockedTasks.length} needs-help or failed work item(s).`, 'Resolve needs-help work before expansion or paid conversion ask.'),
