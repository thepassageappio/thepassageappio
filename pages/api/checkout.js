...
const PLANS = {
  ...
  partner_local: {
    label: 'Passage Partner Single Location',
    amount: 24999,
    mode: 'subscription',
    interval: 'month',
    partnerPlan: true,
  ...
  partner_group: {
    label: 'Passage Partner Multi-Location',
    amount: 34999,
    mode: 'subscription',
    interval: 'month',
    partnerPlan: true,
  ...
  partner_location_addon: {
    label: 'Passage Additional Funeral Home Location',
    amount: 9900,
    mode: 'subscription',
    interval: 'month',
    partnerPlan: true,
    locationAddon: true,
    includedLocationSlots: 1,
    priceEnv: ['STRIPE_PRICE_FUNERAL_HOME_LOCATION_ADDON_MONTHLY', 'STRIPE_PRICE_PARTNER_LOCATION_ADDON_MONTHLY'],
  },
  monthly: null,
  semiannual: null,
  annual: null,
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const body = new URLSearchParams({
      ...
      'metadata[includedLocationSlots]': String(plan.includedLocationSlots || 0),
      'metadata[additionalLocationFeeCents]': String(plan.additionalLocationFeeCents || 0),
      'metadata[locationAddon]': plan.locationAddon ? 'true' : 'false',
      'metadata[activeCaseLimit]': plan.activeCaseLimit == null ? '' : String(plan.activeCaseLimit),
