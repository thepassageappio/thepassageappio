...
export default async function handler(req, res) {
  ...
  const body = message || `A gentle reminder from Passage: ${task.title || 'your assigned request'} is still waiting for your confirmation. You can own the request, mark it done, or ask for help here: ${link}`;
  if (!dryRun) {
