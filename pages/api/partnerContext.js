  ...
  const cases = [
    {
      ...
      tasks: [
        { id: 'demo-collins-task-1', workflow_id: 'demo-collins-price', title: 'Confirm cemetery plot details', description: 'Ask family for section, lot number, and deed photo before the arrangement meeting.', status: 'waiting', assigned_to_name: 'Robert Alvarez', assigned_to_email: 'robert@collinsffh.demo', created_at: '2026-05-08T13:00:00Z', last_action_at: '2026-05-08T14:30:00Z', proof_required: 'Family reply or cemetery record', automation_level: 'semi_automated' },
        { id: 'demo-collins-task-2', workflow_id: 'demo-collins-price', title: 'Prepare the funeral home meeting summary', description: 'Organize dates, family contact, service preferences, and open questions into one prepared packet.', status: 'assigned', assigned_to_name: 'Maria Collins', assigned_to_email: 'maria@collinsffh.demo', created_at: '2026-05-08T15:00:00Z', proof_required: 'Prepared packet', automation_level: 'semi_automated' },
        { id: 'demo-collins-task-3', workflow_id: 'demo-collins-price', title: 'Send obituary approval request', description: 'Send the family a clean approval request with the current obituary draft.', status: 'blocked', assigned_to_name: 'Robert Alvarez', assigned_to_email: 'robert@collinsffh.demo', created_at: '2026-05-08T10:00:00Z', proof_required: 'Family approval', automation_level: 'semi_automated' },
        { id: 'demo-collins-task-4', workflow_id: 'demo-collins-price', title: 'Record hospital release confirmation', description: 'Hospital release was confirmed and saved for transportation.', status: 'handled', assigned_to_name: 'Maria Collins', assigned_to_email: 'maria@collinsffh.demo', created_at: '2026-05-08T09:00:00Z', last_action_at: '2026-05-08T11:00:00Z', proof_required: 'Release confirmation', automation_level: 'automated' },
      ],
      ...
      familyParticipants: [
        { id: 'demo-collins-family-michael', workflow_id: 'demo-collins-price', name: 'Michael Price', email: 'michael.price@example.com', phone: '845-555-0137', role: 'family_coordinator', invite_status: 'accepted', accepted_at: '2026-05-08T15:30:00Z', invite_token: 'demo-price-family-token', created_at: '2026-05-08T15:00:00Z' },
        { id: 'demo-collins-family-sarah', workflow_id: 'demo-collins-price', name: 'Sarah Price', email: 'sarah.price@example.com', phone: '845-555-0198', role: 'participant', invite_status: 'sent', invite_token: 'demo-price-helper-token', created_at: '2026-05-08T15:10:00Z' },
      ],
      vendorRequests: [
    ...
    },
    {
      ...
      tasks: [
        { id: 'demo-collins-green-1', workflow_id: 'demo-collins-reed', title: 'Collect pre-need preferences', description: 'Capture wishes, contacts, documents, and activation people before it is urgent.', status: 'assigned', assigned_to_name: 'Maria Collins', assigned_to_email: 'maria@collinsffh.demo', created_at: '2026-05-07T09:00:00Z', proof_required: 'Preferences saved', automation_level: 'semi_automated' },
        { id: 'demo-collins-green-2', workflow_id: 'demo-collins-reed', title: 'Confirm activation contacts', description: 'Name who should be contacted when the family needs the plan activated.', status: 'waiting', assigned_to_name: 'Anna Reed', assigned_to_email: 'anna.reed@example.com', created_at: '2026-05-07T10:00:00Z', proof_required: 'Activation contact confirmed', automation_level: 'manual' },
      ],
      blockedTasks: [],
      communications: [],
      waitingOnFamily: [{ id: 'demo-collins-green-wait', title: 'Activation contacts' }],
      familyParticipants: [
        { id: 'demo-collins-family-anna', workflow_id: 'demo-collins-reed', name: 'Anna Reed', email: 'anna.reed@example.com', phone: '845-555-0104', role: 'planning_coordinator', invite_status: 'accepted', accepted_at: '2026-05-07T11:00:00Z', invite_token: 'demo-reed-family-token', created_at: '2026-05-07T10:45:00Z' },
      ],
      vendorRequests: [],
      activity: [],
      serviceEvents: [],
    ...
    },
    {
      ...
      familyParticipants: [
        { id: 'demo-collins-family-claire', workflow_id: 'demo-collins-after', name: 'Claire Ellis', email: 'claire.ellis@example.com', phone: '845-555-0144', role: 'executor', invite_status: 'accepted', accepted_at: '2026-05-06T10:30:00Z', invite_token: 'demo-ellis-family-token', created_at: '2026-05-06T10:00:00Z' },
      ],
      vendorRequests: [],
