...
const PAGE_META = {
  ...
  '/funeral-home/login': ['Funeral Home Sign In | Passage', 'Funeral home directors and staff open the private Passage dashboard for active cases, My Day, staff work, proof, and setup.'],
  '/funeral-home/setup': ['Create Funeral Home Workspace | Passage', 'Create a funeral-home dashboard with owner access, location context, and staff invitations.'],
  ...
  '/care-providers': ['Care Providers | Passage', 'Passage helps hospice, assisted living, senior living, and home-care teams create family-owned handoffs into planning ahead, urgent help, funeral homes, vendors, and aftercare.'],
  '/hospice': ['Hospice Continuity | Passage', 'A care-prep family record for hospice and care teams to prepare contacts, first-call plans, permissions, and funeral-home handoffs before the crisis moment.'],
  ...
  '/participating': ['Participant Request | Passage', 'Sign in to open a private, scoped Passage request assigned by a family or coordinator.'],
  ...
  '/vendors/request': ['Vendor Request | Passage', 'Approved vendors open scoped Passage requests, quote service details, and keep families updated without browsing family records.'],
  '/urgent': ['Urgent Help | Passage', 'Start an urgent family record for the first practical steps after a death.'],
  '/planning': ['Plan Ahead | Passage', 'Create a planning estate with wishes, documents, people, providers, and activation rules.'],
  '/login': ['Sign In | Passage', 'Choose the Passage surface you need: family record, participant request, funeral home, vendor, or admin.'],
