...
const takeaways = [
  ...
  ['Live public UAT sweep', 'Production green / source queued behind Vercel rate limit', 'Production is green at commit 298c3fe with no public internal/revenue leaks in the checked persona pages. Latest source is ahead of production and blocked by Vercel production build rate limit after de8a761; based on the June 19, 2026 04:57 UTC status, retry is approximately June 20, 2026 12:57 AM ET. Keep batching source fixes, then verify www.thepassageapp.io, X-Passage-Commit, customer copy, and persona flows before promotion.'],
