...
const takeaways = [
  ...
  ['Task-card and request-card clarity', 'Source hardened / deploy green', 'Shared cards now have a concrete readiness contract: action needed, owner, waiting party, prepared message, status/proof, and privacy boundary. Public/vendor/helper wording favors request, record, owner, waiting point, and proof over task-spine or command-center jargon. Latest green deploy still needs custom-domain verification after www routing is corrected.'],
