...
const takeaways = [
  ['Funeral-home action-card QA', 'Deployed green / source continuing', 'Latest green production fixed the broken address component, then clarified funeral-home director/staff cards into action needed, owner, waiting on, proof/status, prepared output, and one primary action. Current batch routes participant, vendor, and roadmap sign-in through the server Google redirect so buttons do not silently depend on client OAuth hydration.'],
