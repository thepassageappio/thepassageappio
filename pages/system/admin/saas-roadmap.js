...
const takeaways = [
  ...
  ['Live public UAT sweep', 'P0 release routing', 'Latest source deploy 2dd90bb is green in both Vercel production contexts, but www.thepassageapp.io still serves older homepage copy including sample funeral-home console and Spine labels. Treat custom domain, alias, Cloudflare, and cache routing as P0 before LinkedIn promotion, paid pilots, or final persona QA signoff. Public readiness now compares X-Passage-Commit against the current Vercel commit so stale pages become an explicit blocker.'],
