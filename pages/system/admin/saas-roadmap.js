...
const takeaways = [
  ...
  ['Task-card and request-card clarity', 'Source hardened / deploy verification pending', 'Family and funeral-home cards now use a concrete operator contract: 1. do next, owner, waiting party, message to send or use, status/proof, and privacy boundary. Public/vendor/helper wording favors request, record, owner, waiting point, proof, and next step; participant confirmations now say request instead of task, and vendor/care-provider copy no longer leaks task wording into scoped external requests. Latest deploy still needs custom-domain/browser verification after www routing and Chrome automation are corrected.'],
  ...
  ['Family, care, and participant UX', 'Source simplified / live domain stale', 'B2C, urgent, planning, hospice/care-prep, and participant requests now favor family record, request, next step, owner, waiting point, and proof. Family homepage/dashboard copy now says who owns each next step, prepared output, proof, and active plan without broken placeholder separators. Live www must still be rechecked after routing/cache is fixed.'],
