...
const takeaways = [
  ...
  ['Family, care, participant, and vendor UX', 'Source simplified / vendor-card copy queued behind rate limit', 'B2C, urgent, planning, hospice/care-prep, participant, vendor, and care-provider flows now favor family record, request, next step, owner, waiting point, proof, and scoped access. Family homepage/dashboard copy now says who owns each next step, prepared output, proof, active plan, and next-step lists without broken placeholder separators. Participant and vendor surfaces now say own the request, show what is waiting, save completion proof, and approve quote before work starts instead of accept/mark-completed/task language. Vendor lifecycle labels now say Quote Approved, approval/payment next step, and approve-and-pay; scoped vendor request pages no longer say family/funeral home accepts the quote, and both visible and legacy vendor response paths now prevent schedule/complete actions before approval/payment. Vendor onboarding, care-provider inquiry, hospice/care-prep, contact, and funeral-home public copy now use provider/care-team/waiting-point language and avoid vague partner/stuck/internal wording. Live www must still be rechecked after routing/cache is fixed and Vercel deploys resume.'],
