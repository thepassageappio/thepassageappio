...
const sprints = [
  ...
  },
  {
    ...
    tasks: [
      ...
      'Access reliability: global login, pricing checkout, funeral-home setup, vendor, participant, and System Admin sign-in buttons must all use /auth/google, show a clear failure state and alternate path when auth is missing or OAuth fails, and land the user back in the intended role page.',
    ],
