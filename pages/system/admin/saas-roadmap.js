...
const takeaways = [
  ...
  ['Live public UAT sweep', 'Production green / latest batch rate-limited', 'Production is green through the funeral-home Director Focus and internal-wording cleanup. The latest vendor support card copy is committed but blocked by Vercel production build rate limit until about June 19, 2026 4:44 PM ET. Keep batching source fixes, then verify www.thepassageapp.io, X-Passage-Commit, customer copy, and persona flows before promotion.'],
  ...
  ['Funeral-home product UX', 'Production verified / next case-detail pass pending', 'Director/staff dashboard now uses Director Focus, My Day, Case at a glance, Recommended next action, quote-review attention, a case-level vendor quote decision block, work-card contracts, one primary action, one waiting action, collapsed More actions, what Passage prepared, what staff does next, waiting point, proof saves, needs-help wording, family-visible proof, and customer-safe setup, invite, queue, vendor preference, and billing language with visible pilot/trial wording, quote-accepted labels, and raw plan ids removed from the customer dashboard. Setup now uses funeral-home/customer language, a logged-out recommended next action, a required-info gate, direct demo-dashboard access, and first next-step/work-card wording instead of partner/task wording. Inbound family requests now show clean contact separators and operator-safe accept/decline/convert controls. Authenticated UAT verified My Day, Director Focus, and quote-review attention in Chrome. Next browser pass should verify the deployed case-level quote decision block and estate handoff after Chrome stabilizes.'],
  ['Family, care, participant, and vendor UX', 'Production/source pass active', 'B2C, urgent, planning, hospice/care-prep, participant, vendor, and care-provider flows now favor family record, request, next step, owner, waiting point, proof, and scoped access. Family homepage/dashboard copy now says who owns each next step, prepared output, proof, active plan, and next-step lists without broken placeholder separators. Participant and vendor surfaces now say own the request, show what is waiting, save completion proof, and approve quote before work starts instead of accept/mark-completed/task language. Vendor lifecycle labels now say Quote Approved, approval/payment next step, and approve-and-pay; scoped vendor request pages no longer say family/funeral home accepts the quote, and both visible and legacy vendor response paths now prevent schedule/complete actions before approval/payment. Vendor onboarding, care-provider inquiry, hospice/care-prep, contact, participant landing, and funeral-home public copy now use provider/care-team/request/waiting-point language and avoid vague partner/stuck/internal wording. Participant scoped-access copy now says request/timing/proof instead of task, and care-prep dates stay visible as waiting items instead of tasks. Live www must still be rechecked after routing/cache is fixed and Vercel deploys resume.'],
  ['Automation layer', 'Source updated / deploy blocked by rate limit', 'Timing-aware next-action scoring now feeds funeral-home recommendations, and admin readiness now quantifies automated, semi-automated, and manual work with the blockers preventing automation. Next deploy must browser-verify visible timing, why-now reasons, and automation coverage.'],
...
const sprints = [
  ...
  },
  {
    ...
    status: 'Production verified / case-detail pass next',
  ...
  },
  {
    ...
    tasks: [
      'Family coordinator: urgent setup, planning setup, care-prep record, one recommended next action, what Passage prepares, where proof saves, approvals, family updates, aftercare, and care-team waiting items.',
