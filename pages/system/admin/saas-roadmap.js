...
const takeaways = [
  ...
  ['Task-card and request-card clarity', 'Source overhaul active', 'This is now a product-model overhaul, not a copy pass. Funeral-home director/staff cards already use the concrete operator contract: do next, owner, waiting party, prepared message/output, status/proof, and privacy boundary. Latest queued source starts the same change on the family coordinator plan: legacy list rows now render as FamilyOperatingStepCard components driven by taskOperatingContractFor, with status, owner, waiting on, prepared output, proof destination, visibility, one primary action, and details behind the action. Remaining work before claiming complete: redesign the family execution modal and estate/persona detail surfaces so every role gets a different, calmer operating lane rather than a renamed task list.'],
  ...
  ['Family, care, participant, and vendor UX', 'Production/source pass active', 'B2C, urgent, planning, hospice/care-prep, participant, vendor, and care-provider flows now favor family record, request, next step, owner, waiting point, proof, and scoped access. Latest queued source makes the family coordinator plan feel structurally different: the first action and tier rows are operating-step cards with owner, waiting, prepared output, proof, visibility, and one primary action. Participant and vendor surfaces now say own the request, show what is waiting, save completion proof, and approve quote before work starts instead of accept/mark-completed/task language. Vendor lifecycle labels now say Quote Approved, approval/payment next step, and approve-and-pay; scoped vendor request pages no longer say family/funeral home accepts the quote, and both visible and legacy vendor response paths now prevent schedule/complete actions before approval/payment. Vendor onboarding, care-provider inquiry, hospice/care-prep, contact, participant landing, and funeral-home public copy now use provider/care-team/request/waiting-point language and avoid vague partner/stuck/internal wording. Remaining source work: the family execution modal and estate detail surfaces need the same non-cosmetic operating-lane redesign before the persona overhaul is complete.'],
