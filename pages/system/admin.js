...
const roadmapItems = [
  ...
  },
  {
    ...
    priority: 'P0',
    timing: 'Done today',
    status: 'Plain spine cards audited across personas',
    title: 'Make every task card explain the ask, owner, waiting point, proof, and notification path',
    body: 'The simplified card pass was reviewed against the full spine, not treated as a cosmetic change. The family task spine now shows the universal lifecycle directly: Owner, Ask, Waiting, Proof, Done. Participant cards show Start here, Asked of you, Owner, Waiting, and Proof and notify before secondary context, and a saved note stays visible immediately even if live context is still refreshing. Estate task cards now keep the selected task state separate from overall estate counts, so a ready task does not inherit another task’s blocked/waiting color and a blocked task keeps its own waiting point visible. Public demo mode now opens a sample family task spine and a sample vendor request without sign-in, so Steve can show the same lifecycle across family, participant, funeral-home, and vendor roles. Estate, funeral-home, and vendor task panels use the same contract so coordinators, staff, and scoped vendors see the ask, owner, waiting point, proof, and notification state before marking handled, waiting, blocked, assigning, quoting, or sending. The backend rejects handled, waiting, or blocked task updates that do not include meaningful proof, waiting point, or blocker detail. Task send and reminder endpoints return the same spine contract with recipient, deep link, waiting point, proof, and notification status, and the orchestration smoke test verifies participant, funeral-home, vendor, assignment, reminder, notification, and payment/proof contracts separately.',
  },
  {
