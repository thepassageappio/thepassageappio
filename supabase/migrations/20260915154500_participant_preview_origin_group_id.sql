-- Additive: expose origin_group_id on participant invitation preview so /r/[token]
-- can show the multi-institution bank-only one-liner when this case was spawned
-- from a multi-institution submission. No behavior change for single-institution.
...
begin
  ...
  return jsonb_build_object(
    ...
    'origin_group_id', v_record.origin_group_id
  );
end;
$$;
