-- Passage document packets review queue.
-- Do not apply to production without owner approval.
-- This supports the task spine: task -> output packet -> review -> proof -> reporting.
...
-- Policy shape intentionally mirrors family/provider access used elsewhere.
-- Review before applying: production schemas vary across Passage environments.
