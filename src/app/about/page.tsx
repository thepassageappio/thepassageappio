...
export const metadata: Metadata = {
  title: "About",
  description: "Passage helps banks review requests from people helping someone with their account.",
      ...
      <div className={`${styles.content} ${plain.content}`}>
        <section className={plain.story} aria-labelledby="simple-example">
          ...
          <div>
            ...
            <p><strong>That is the purpose of Passage:</strong> help everyone know what the bank needs and what it has decided.</p>
          </div>
        </section>
        ...
        <section className={styles.grid2} aria-label="Important boundaries">
          <article className={styles.card}>
            ...
            <p>The bank or credit union must use Passage before it can invite you. It reviews the request and makes its own decision.</p>
          </article>
          <article className={styles.card}>
            <span>How is identity checked?</span>
            <h2>The bank checks who each person is.</h2>
          ...
          <article className={styles.card}>
            ...
            <p>The receipt is a saved copy of the bank’s answer. It shows who can do what, for which account, and until when. It also shows the reason and any later changes.</p>
          </article>
          <article className={styles.card}>
        ...
        <section className={styles.callout}>
          <div><h2>Follow an example from start to finish.</h2><p>See what each person does, what the bank checks, and how everyone sees the answer.</p></div>
          <Link className={styles.cta} href="/sample">Try the example</Link>
        </section>
      </div>
      <CommercialFooter />
    </main>
