  ...
  return <main className={styles.page}>
    ...
    <div className={styles.content}>
      <section className={styles.pricing}>
        <article className={styles.tier}><span>Try us free</span><h2>Evaluation</h2><div className={styles.price}>$0</div><p>Run five authority transactions over 10 days. The clock starts with the first activated request.</p><ul><li>No card required</li><li>Financial POA workflow</li><li>Decision receipts, API, and webhook replay</li></ul><Link className={styles.secondary} href="/start">Start free</Link></article>
