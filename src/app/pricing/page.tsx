  ...
  return <main className={styles.page}>
    ...
    <div className={styles.content}>
      <section className={styles.pricing}>
        ...
        <article className={styles.tier}><span>Scale after proof</span><h2>Institution</h2><div className={styles.price}>Custom</div><p>Shape the ongoing relationship from proven transaction volume, workflow needs, and required services.</p><ul><li>Hosted and embedded flows</li><li>Review operations and policy controls</li><li>API, webhooks, and lifecycle monitoring</li></ul></article>
      </section>
