...
export default async function PoliciesPage() {
  ...
  return (
    <>
      <header className={styles.pageHeader}><div><p className={styles.eyebrow}>Authority policy</p><h1>New York financial POA</h1><p>This checklist is used for the sample requests. Your institution reviews the documents and makes the final decision.</p></div><span className={styles.badge}>Active</span></header>
      <div className={styles.grid}>
        <section className={styles.panel}>
          <div className={styles.panelHead}><div><h2>Controlled evaluation scope</h2><p>The sample covers statement copies and account questions. You cannot change the institution’s rules in Passage yet.</p></div></div>
