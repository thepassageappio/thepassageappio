    ...
    <>
      ...
      <div className={styles.grid}>
        ...
        <section className={styles.panel}>
          ...
          <dl className={styles.policyFacts}><div><dt>Policy</dt><dd>New York financial power of attorney</dd></div><div><dt>Version</dt><dd>{selection.template_version}</dd></div><div><dt>New York rules</dt><dd>{packLabel}</dd></div><div><dt>Who decides?</dt><dd>The bank or credit union</dd></div><div><dt>Does Passage decide if the document is legally valid?</dt><dd>No. The institution reviews it.</dd></div></dl>
        </section>
      </div>
    </>
  );
