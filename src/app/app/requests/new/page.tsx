    ...
    <form action={createHostedAuthorityDraftAction} className={requestStyles.form}>
      ...
      <section className={styles.panel}>
        ...
        <div className={requestStyles.formGrid}>
          <label className={styles.field}>Person granting authority<input name="principalName" required autoComplete="name" placeholder="Full legal name" defaultValue={useSample ? "Eleanor Demo" : ""} /></label>
          ...
          <label className={styles.field}>Representative<input name="representativeName" required autoComplete="name" placeholder="Full legal name" defaultValue={useSample ? "Maya Demo" : ""} /></label>
      ...
      <section className={styles.panel}>
        ...
        <label className={styles.field}>Account or relationship covered<input name="accountBoundary" required placeholder="For example, membership account ending 4821" defaultValue={useSample ? "Sample membership account ending 4821" : ""} /></label>
