  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.document}>
        ...
        <h2>Information used</h2><p>Passage may process account identity, organization profile, team membership, authority-request details, participant contact information, evidence references, review decisions, and security and audit events needed to operate the workflow. When someone requests the gated sample, Passage also records the acquisition source and the version of their contact consent.</p>
        <h2>How information is used</h2><ul><li>Authenticate people and enforce organization and record access.</li><li>Coordinate the requested authority review and show each person the next action.</li><li>Preserve consent, disclosure, decision, revocation, expiration, and access history.</li><li>Send sample follow-up, product updates, or a walkthrough invitation when the person separately opts in.</li><li>Protect, troubleshoot, and improve the service.</li></ul>
        ...
        <h2>Your choices</h2><p>Organization owners can manage team access. Participants can review what they are asked to share and the later actions available to them. Marketing contact requires a separate choice and may be withdrawn through the unsubscribe link in any marketing message. Requests for access, correction, export, or deletion are handled subject to legal, security, and record-retention requirements.</p>
      </article>
    </main>
  );
}
