...
const resources = [
  ["Operations", "A clearer way to handle power of attorney requests", "How to separate participant input, document review, institution decisions, and later changes.", "/resources/financial-poa-operations"],
  ["Auditability", "What to include in a decision receipt", "The details people need to check that they have the same answer.", "/resources/decision-receipts"],
  ["Integration", "Try Passage before connecting other systems", "Start with a complete workflow, then connect requests and updates to existing systems.", "/resources/hosted-first-integration"],
];
