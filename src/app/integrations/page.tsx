...
export default function Integrations() {
  return <main className={styles.page}>
    ...
    <section className={styles.hero}><p className={styles.eyebrow}>Start hosted. Connect when ready.</p><h1 id="page-content" tabIndex={-1}>Try Passage before connecting your systems.</h1><p>First, complete a request in Passage. Then plan how your own system will send requests and receive updates.</p></section>
    <div className={styles.content}>
      ...
      <section className={styles.callout}><div><h2>One request stays in sync.</h2><p>Start by using Passage on its own. Add a connection when you know what your team needs.</p></div><Link className={styles.cta} href="/contact">Plan a demo</Link></section>
    </div>
    <CommercialFooter />
  </main>;
}
