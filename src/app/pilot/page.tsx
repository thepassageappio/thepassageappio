...
export default function Pilot() {
  return <main className={styles.page}>
    ...
    <div className={styles.content}>
      ...
      <section className={styles.callout}><div><h2>Experience the complete workflow.</h2><p>Start as the institution, then move through every participant, reviewer, receipt, revocation, and integration state.</p></div><Link className={styles.cta} href="/institution/new">Explore the product</Link></section>
    </div>
  </main>;
}
