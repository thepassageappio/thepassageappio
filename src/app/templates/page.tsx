  ...
  return <main className={styles.page}>
    ...
    <div className={styles.content}>
      <section className={styles.grid2}>
        <article className={styles.card}><span>Available now</span><h2>New York financial POA</h2><p>For narrow deposit-account servicing. Includes scope confirmation, POA review, representative certification, identity, address, institution review, decision receipt, revocation, and webhooks.</p><Link className={styles.secondary} href="/institution/new">Use this template</Link></article>
