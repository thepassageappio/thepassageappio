  ...
  return (
    <>
      ...
      <section className={styles.panel}>
        <div className={styles.panelHead}><div><h2>Verified authenticators</h2><p>Set up the backup app on a separate device. Keep its setup code private.</p></div><span className={styles.badge}>{factors.length} verified</span></div>
        ...
        <p>You cannot remove an authenticator here. Contact Passage for help so the change can be checked and recorded.</p>
      </section>
      <section className={styles.panel}>
        <div className={styles.panelHead}><div><h2>Add a backup authenticator</h2><p>A backup app lets you sign in if you lose your main device. Passage does not provide recovery codes.</p></div></div>
