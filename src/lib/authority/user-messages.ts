...
const errorMessages: Record<string, string> = {
  ...
  draft_update_not_available: "Contact details can only be changed while this request is still a draft. After send, use a fresh link instead.",
  draft_update_input_invalid: "Review the contact details and try saving again.",
...
const noticeMessages: Record<string, string> = {
  ...
  draft_updated: "Contact details were updated on this draft. Nothing was sent or counted.",
