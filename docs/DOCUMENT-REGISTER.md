...
| 18 | `DEMO-ENVIRONMENT-ARCHITECTURE.md` | Evidence-backed isolated Demo topology, release parity, synthetic reset model, provider boundaries, and implementation acceptance criteria |
