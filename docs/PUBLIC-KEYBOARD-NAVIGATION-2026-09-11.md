...
Follow-up: [JavaScript recovery guidance](JAVASCRIPT-RECOVERY-2026-09-11.md) now resolves the unexplained waiting state with clear instructions. The app still requires JavaScript; the earlier full no-script keyboard run remains a failed test, not retroactively passed.
