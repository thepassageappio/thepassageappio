...
- PR #95 merged as `8e3ca10d7241f17815a4a154ef5e144c558268ac`. Production serves that exact GitHub `main` SHA with `provenance: verified`; both Vercel commit checks passed.
