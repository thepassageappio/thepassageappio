...
The immediate priority is the [fresh buyer demo](../BUYER-DEMO-PRIORITY-2026-09-11.md). The owner approved the rehearsal invitations and receipts after being told their purpose. The two intended participant email addresses remain pending; use only the pair the owner supplies. No fresh timed rehearsal or inbox-delivery proof is claimed. Continue independent usability checks without sending email.
