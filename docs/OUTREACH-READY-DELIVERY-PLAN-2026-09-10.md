...
| POL1 | Institution configuration | Governed action/evidence/channel/control catalogs; draft and publish immutable policy; pin snapshots; explicit stale-draft rebase; preserve activated history; test before/after publication | Overview, snapshot encoding/comparison and private content storage implemented locally; compiler, publication, request binding and rebase remain unbuilt |
