...
- **How Passage's evidence flow does/doesn't support institution review here:** Passage's schema already has a distinct requirement type, `representative_certification`, separate from `power_of_attorney` and `identity_evidence` — which is structurally well-suited to capturing something like Pennsylvania's agent Acknowledgment, if that's in fact what that requirement type is used for today. **This needs direct confirmation from engineering**, not just this document review: does the representative-certification step, as currently built and as configured for the New York wedge, actually capture a document equivalent to Pennsylvania's statutory Acknowledgment, or is it currently just a generic "I certify I am who I say I am" attestation? If it's the latter, expanding into Pennsylvania without adapting that step risks an institution relying on a decision receipt for a representative who, under Pennsylvania law, has no actual authority to act yet.
- **Open questions for counsel:** Confirm the Acknowledgment requirement and its consequences if omitted. Confirm whether Passage's existing `representative_certification` requirement type needs Pennsylvania-specific content, or whether that's purely an institution-configuration question the product already supports.
...
- Pennsylvania: [Nolo — Pennsylvania Power of Attorney Laws](https://www.nolo.com/legal-encyclopedia/pennsylvania-power-of-attorney-laws.html); [Timoney Knox LLP — Changes to the Power of Attorney in Pennsylvania](https://www.timoneyknox.com/pennsylvanias-new-power-of-attorney-law-what-you-need-to-know/); [Robert C. Gerhard III — Pennsylvania POA Documents Must Meet Certain Requirements](https://www.paelderlaw.net/pennsylvania-power-of-attorney-documents-must-meet-certain-requirements/)
