...
- Still required for the full target: namespaced `demo_run` provisioning, a presenter allowlist for reset/provision commands, independent four-profile persona UAT, a separate Demo email-provider credential, and a timed seven-minute rehearsal.
