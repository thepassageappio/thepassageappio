// Passage — LEGACY funeral-home marketing page, preserved verbatim for rollback.
// This is the prior serif design extracted from pages/funeral-home/index.js so it
// can be rendered per-page via the ?legacy=1 seam while the redesign is the
// default. Identical behavior to the original page: same routes, same analytics
// (funeral_home_cta_clicked, funeral_home_plan_start_clicked,
// funeral_home_plan_cta_clicked), same checkout flow, same auth slot.
...
export default function FuneralHomeLegacy() {
