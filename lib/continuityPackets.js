...
export function buildContinuityPackets(input = {}) {
  return [
    {
      id: 'hospice-handoff',
      title: 'Care-team / warm-path handoff',
      description: 'Carries caregiver, hospice or facility context, family coordinator, preferences, missing items, and first-hour guidance into the red path.',
