export const RATE_LIMIT_POLICIES = {
  ...
  contactIntake: {
    ...
    routes: ['/api/saveLead', '/api/supportInquiry', '/api/vendors/apply', '/api/careProviders/apply', '/api/funeralHomeRequests'],
    windowSeconds: 3600,
    maxRequests: 5,
    identity: 'ip+email',
  ...
  providerLookup: {
    label: 'Provider and address lookup',
    routes: ['/api/providerSearch', '/api/addressAutocomplete'],
    windowSeconds: 60,
    maxRequests: 25,
    identity: 'ip+query+lookupType',
    response: 'Return 429 before calling Google Places or address lookup providers.',
  },
  authSensitive: {
  ...
  adminReadiness: {
    ...
    routes: ['/api/system/rateLimitReadiness', '/api/system/funeralHomePilotHealth', '/api/system/*Readiness', '/api/system/orchestrationSmokeTest'],
    windowSeconds: 60,
    maxRequests: 10,
    identity: 'adminUser+ip+route',
  ...
  outboundDelivery: {
    ...
    routes: ['/api/sendEmail', '/api/sendSMS', '/api/tasks/[id]/send', '/api/tasks/[id]/reminder', '/api/partnerInvite', '/api/partnerStaffInvite', '/api/funeralHomePrepEmail', '/api/familyUpdate', '/api/callNow', '/api/processTaskReminders', '/api/processVendorReminders', '/api/processScheduledDeliveries'],
    windowSeconds: 3600,
    maxRequests: 20,
