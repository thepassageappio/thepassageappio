...
export function vendorStatusLabel(status) {
  ...
  if (value === 'family_accepted') return 'Family Accepted';
...
export function paymentStatusLabel(status) {
  ...
  if (status === 'family_accepted') return 'Family Accepted';
...
export function vendorNextExpected(status, paymentStatus) {
  ...
  if (value === 'family_accepted') return 'Family accepted the quote. Payment checkout is the next step.';
  if (value === 'quoted') return 'Quote ready. Waiting for the family or coordinator to accept and pay.';
