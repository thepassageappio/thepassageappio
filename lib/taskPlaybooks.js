...
export const AUTOMATION_LEVELS = {
  ...
  PARTNER_HANDOFF: {
    ...
    label: 'Funeral home or partner handoff',
    shortLabel: 'Tier 2',
    explanation: 'Passage prepares the handoff and tracks proof, but a person or partner still completes the work.',
  },
  PREP_TRACK: {
    level: 2,
    tier: 'Assisted execution',
...
function executionTruthFor(playbook, level, execution) {
  ...
  if (mode === 'record') {
    return {
      ...
      explanation: 'Passage saves this detail so it can feed packets, messages, summaries, and later tasks.',
