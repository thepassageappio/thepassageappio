export const CARE_PROVIDER_TYPES = {
  hospice: {
    ...
    description: 'Hospice teams can help families prepare the practical handoff before the crisis moment: who to call, who owns decisions, what is known, and what should move into urgent coordination when death occurs.',
    path: '/hospice',
  },
  assisted_living: {
...
export const CARE_PROVIDER_SPINE_STEPS = [
  ['1', 'Start the family record', 'Create a care-prep record with the family coordinator, care context, trusted people, and what is already known.'],
  ...
  ['4', 'Activate when needed', 'If death occurs, the activation circle confirms the transition and the same record opens urgent coordination.'],
...
export const CARE_PROVIDER_PRICING = [
  {
    ...
    features: ['1 location or care team', '10 active family records', 'Care-prep intake and family ownership', 'Basic handoff reporting'],
