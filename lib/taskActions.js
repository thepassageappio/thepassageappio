...
export const TASK_ACTIONS = {
  accept: {
    ...
    shortLabel: 'Accept',
    prompt: 'Add anything the coordinator should know before you take this on.',
    placeholder: 'Example: I can make this call this afternoon.',
    confirmation: 'Accepted. The coordinator can see that you own this task.',
    requiresNote: false,
  },
  handled: {
    status: 'handled',
    label: 'Record proof',
    shortLabel: 'Handled',
    prompt: 'What proof, reference, name, or timestamp shows this happened?',
    placeholder: 'Example: Release confirmed by Vassar Hospital, reference #1234.',
    confirmation: 'Proof saved. This task is marked handled.',
    requiresNote: true,
  },
  waiting: {
    status: 'waiting',
    label: 'Still waiting',
    shortLabel: 'Waiting',
    prompt: 'Who or what are you waiting on, and what should happen next?',
    placeholder: 'Example: Waiting on the facility release desk to call back.',
    confirmation: 'Waiting update saved. Passage will keep this visible.',
    requiresNote: true,
  },
  blocked: {
    status: 'blocked',
  ...
  save_note: {
    status: null,
    label: 'Save note',
    shortLabel: 'Save note',
    prompt: 'Add a note for the coordinator.',
