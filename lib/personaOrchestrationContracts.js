export const personaOrchestrationContracts = [
  {
    ...
    proof: 'Urgent stabilization context, task status, family update, vendor request, announcement, and event rows stay tied to the same estate.',
    notification: 'Reviewed family update and task assignment email with a direct CTA.',
    ...
    smokeChecks: ['temporary_case_created', 'task_owner_assignment_saved', 'urgent_stabilization_context_visible_in_spine', 'reviewed_family_update_email', 'task_assignment_spine_contract', 'spine_rows_recorded'],
  },
  {
    id: 'participant',
    ...
    notification: 'Task assignment email routes through Passage notification safety.',
    nextState: 'Coordinator sees the participant response and the task remains visible until resolved.',
    smokeChecks: ['participant_assignment_email', 'participant_scoped_waiting_update', 'participant_action_spine_contract', 'spine_rows_recorded'],
  },
  {
    ...
    proof: 'Director-visible task close creates task proof, estate event, notification row, and exportable status.',
    ...
    smokeChecks: ['funeral_home_close_with_proof', 'funeral_home_proof_spine_contract', 'spine_rows_recorded'],
  },
  {
    ...
    proof: 'Employee close/waiting action uses the same partner task handler as director work.',
  ...
  },
  {
    ...
    proof: 'Vendor request, quote, order, payment, Passage fee, vendor net, and paid event all write to the spine.',
    ...
    smokeChecks: ['vendor_scoped_request_created', 'vendor_quote_status_recorded', 'vendor_commerce_no_money_dry_run', 'vendor_request_spine_contract', 'spine_rows_recorded'],
  },
  {
