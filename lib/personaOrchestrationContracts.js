export const personaOrchestrationContracts = [
  {
    ...
    proof: 'Task status, family update, vendor request, announcement, and event rows stay tied to the same estate.',
    notification: 'Reviewed family update and task assignment email with a direct CTA.',
    nextState: 'Coordinator sees owner, waiting point, proof, and next expected update.',
    smokeChecks: ['temporary_case_created', 'reviewed_family_update_email', 'spine_rows_recorded'],
  },
  {
    id: 'participant',
    ...
    smokeChecks: ['participant_assignment_email', 'participant_scoped_waiting_update', 'spine_rows_recorded'],
  },
  {
    ...
    smokeChecks: ['funeral_home_close_with_proof', 'spine_rows_recorded'],
  },
  {
  ...
  },
  {
    ...
    smokeChecks: ['vendor_scoped_request_created', 'vendor_quote_status_recorded', 'vendor_commerce_no_money_dry_run', 'spine_rows_recorded'],
  },
  {
