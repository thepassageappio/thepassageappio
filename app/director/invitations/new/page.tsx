...
import { staffInvitationEnabled } from '@/lib/auth/operational-route-gate';
...
export default async function NewStaffInvitationPage() {
  ...
  const canCreate = staffInvitationEnabled(configuration) && result.ok && ['owner', 'director'].includes(result.viewer.role);
